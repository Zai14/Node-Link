    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        <Text style={[styles.content, { color: colors.text }]}>
          ...
          {"\n"}- As a decentralized application, we do not collect or store
          personal data on centralized servers.
          {"\n"}- We do not have access to your private keys, wallet balances,
          or transaction history.
          {"\n\n"}
          <Text style={[styles.subHeading, { color: colors.subHeading }]}>
            2. Blockchain Data
          </Text>
          {"\n"}- Transactions and interactions occur on the blockchain and are
          publicly visible. We do not control or store this data.
          {"\n"}- Users are responsible for managing their own blockchain data
          and wallet security.
          {"\n\n"}
          <Text style={[styles.subHeading, { color: colors.subHeading }]}>
            3. Use of Third-Party Services
          </Text>
          {"\n"}- Our App may integrate with third-party services (e.g., wallet
          providers, blockchain nodes) that have their own privacy policies.
          ...
          {"\n"}- We do not store sensitive user data, reducing the risk of
          breaches.
          {"\n"}- Users should take precautions such as securing private keys
          and enabling two-factor authentication where applicable.
          {"\n\n"}
          <Text style={[styles.subHeading, { color: colors.subHeading }]}>
            5. Cookies and Tracking
          </Text>
          {"\n"}- We do not use cookies, trackers, or analytics services that
          collect user data.
          {"\n"}- Any tracking or analytics would be performed by third-party
          services you choose to interact with.
          {"\n\n"}
          <Text style={[styles.subHeading, { color: colors.subHeading }]}>
            6. Your Rights and Control
          </Text>
          {"\n"}- Since we do not collect personal data, we do not store
          information that can be modified or deleted.
          {"\n"}- You are in full control of your wallet, private keys, and
          ...
          be communicated via open-source repositories or within the app.
          ...
          {"\n"}- For questions or concerns, reach out to us via
          [Zaidshabir67@icloud.com].
          {"\n"}- Community feedback and contributions are welcome through our
